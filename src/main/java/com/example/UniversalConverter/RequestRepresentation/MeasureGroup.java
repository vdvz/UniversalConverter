...
/**
 * MeasureGroup группирует Unit'ы относящиеся к одному графу (Node с таким же именем содержится в
 * MeasureGraph'e). Например: {км, м, см} - группа построенная на графе мер длины, где км, м, см -
 * Unit'ы, принадлежащие группе; {ч, мин} - группа построенная на графе мер времени, где ч, мин -
 * Unit'ы, принадлежащие группе;
 */
